## A Blender 3D addon that converts lattice shapekeys to mesh shapekeys.
...
Can also be launched from the F3 operator search -> convert lattice shape keys.

This addon will cycle thru all shapekeys on the Lattice and apply them as 'Save as Shape Key' on all mesh objects with a Lattice modifier.
